...
def getlikedsongs():
  ...
  payload = "grant_type=authorization_code&code={}&redirect_uri=http://localhost:5000/callback&client_id=f703f57d46f34a7e9fffc4df3b4a9994&client_secret=1fe906d84e3e4a0db0812483390bbd8b".format(code)
